...
function MostrarPanelSeleccionJugador()
	if ventanaActiva == false then
                ...
                panelPrincipal = guiCreateStaticImage(x*956, y*115, x*372, y*597, ":Seleccion_Usuario/Botones/PanelReg.png", false)
                Camb_Nombre = guiCreateEdit(x*30, y*185, x*311, y*38, "", false, panelPrincipal)
                bh_1 = guiCreateStaticImage(x*90, y*368, x*80, y*80, ":Seleccion_Usuario/Botones/Hombre1.png", false, panelPrincipal)
                bm_1 = guiCreateStaticImage(x*195, y*368, x*80, y*80, ":Seleccion_Usuario/Botones/Mujer1.png", false, panelPrincipal)
                change_s_izq = guiCreateStaticImage(x*108, y*475, x*39, y*40, ":Seleccion_Usuario/Botones/Next4.png", false, panelPrincipal)
                change_s_der = guiCreateStaticImage(x*226, y*476, x*39, y*39, ":Seleccion_Usuario/Botones/Next1.png", false, panelPrincipal)
                Camb_Edad = guiCreateEdit(x*30, y*277, x*311, y*38, "", false, panelPrincipal)
                BotonAceptar = guiCreateStaticImage(x*108, y*534, x*157, y*36, ":Seleccion_Usuario/Botones/Aceptar1.png", false, panelPrincipal)  
                ...
                addEventHandler("onClientGUIClick", bh_1, function()
                        guiStaticImageLoadImage ( bh_1, ":Seleccion_Usuario/Botones/Hombre2.png")
                        guiStaticImageLoadImage ( bm_1, ":Seleccion_Usuario/Botones/Mujer1.png")
                        Sexo = "Masculino"
                        mostrarSkins(Sexo,ped)
                end, false)
                addEventHandler("onClientGUIClick", bm_1, function()
                        guiStaticImageLoadImage ( bh_1, ":Seleccion_Usuario/Botones/Hombre1.png")
                        guiStaticImageLoadImage ( bm_1, ":Seleccion_Usuario/Botones/Mujer2.png")
                        Sexo = "Femenino"
                        mostrarSkins(Sexo,ped)
                end, false)
                addEventHandler("onClientGUIClick", change_s_izq, function()
                        if Sexo ~= "Sin Definir" then
                                guiStaticImageLoadImage ( change_s_izq, ":Seleccion_Usuario/Botones/Next3.png")
                                setTimer ( function()
                                        guiStaticImageLoadImage ( change_s_izq, ":Seleccion_Usuario/Botones/Next4.png")
                                end, 200, 1 )
                ...
                addEventHandler("onClientGUIClick", change_s_der, function()
                        if Sexo ~= "Sin Definir" then
                        guiStaticImageLoadImage ( change_s_der, ":Seleccion_Usuario/Botones/Next2.png")
                        setTimer ( function()
                                guiStaticImageLoadImage ( change_s_der, ":Seleccion_Usuario/Botones/Next1.png")
                        end, 200, 1 )
                ...
                addEventHandler("onClientGUIClick", BotonAceptar, function ()
                        if guiGetText(Camb_Nombre) ~= "" then
                                if guiGetText(Camb_Edad) ~= "" then
                                        guiStaticImageLoadImage ( BotonAceptar, ":Seleccion_Usuario/Botones/Aceptar2.png")
                                        toggleHud(true)
